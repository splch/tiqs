...
_register(
    IonSpecies(
        ...
        repump_transitions=(
            ...
            Transition(
                name="2F7/2 clearout", wavelength=760.0e-9, linewidth=TWO_PI * 0.05e6
            ),
        ),
        qubit_t1=float("inf"),
...
_register(
    IonSpecies(
        ...
        repump_transitions=(
            Transition(
                name="3D3/2 -> 4P1/2", wavelength=866e-9, linewidth=TWO_PI * 1.69e6
            ),
            Transition(
                name="3D5/2 -> 4P3/2", wavelength=854e-9, linewidth=TWO_PI * 1.58e6
            ),
        ),
        qubit_t1=1.168,
...
_register(
    IonSpecies(
        ...
        repump_transitions=(
            Transition(
                name="5D3/2 -> 6P1/2", wavelength=650e-9, linewidth=TWO_PI * 5.3e6
            ),
        ),
        qubit_t1=float("inf"),
...
_register(
    IonSpecies(
        ...
        repump_transitions=(
            Transition(
                name="4D3/2 -> 5P1/2", wavelength=1092e-9, linewidth=TWO_PI * 1.4e6
            ),
        ),
        qubit_t1=0.390,
