...
def raman_scattering_op(
    ...
    In our convention $\sigma_+ = |0\rangle\langle 1|$ maps $|1\rangle$ to
    $|0\rangle$, implementing decay from the excited qubit state. Raman
    scattering changes the qubit state (spin flip), producing a bit-flip
    error. This is the dominant fundamental error source for laser-driven
    gates.
    """
