...
print("M_22 from C_004 is exactly epsilon-independent (B.1, axial")
print("only). M_22 from C_012 is second-order in C_012 and does")
print("depend on epsilon through em, ep, gp (B.7), but is numerically")
print("negligible at v3p4 -- so the required C_004 compensation is")
print("tiny and varies only weakly with epsilon. The RADIAL shifts")
print("(M_00, M_02, etc.) DO change with epsilon by orders of")
print("magnitude, affecting mode coupling and qubit coherence.")
...
print()
print("4. The compensation C_004 = -M_22^012/M_22^004 is tiny at")
print("   v3p4 (M_22^012 is second-order in C_012) and varies only")
print("   weakly with epsilon. The radial matrix elements change")
print("   with epsilon by orders of magnitude.")
print()
